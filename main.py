...
want_to_file_imread = cv2.imread(want_to_file)
...
source_file_imread = cv2.imread(source_file)
...
source_img = ins_get_image(source_file_imread)
want_to_img = ins_get_image(want_to_file_imread)
